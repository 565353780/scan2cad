...
class DatasetOnlineLoad(torchdata.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {
            ...
            "scale": scale,
            "p_scan": p_scan,
            "basename_save": basename_save,
            "voxres_scan": vox_center.res,
            "voxres_cad": vox_heatmap.res,
            "grid2world_scan": vox_center.grid2world,
            "grid2world_cad": vox_heatmap.grid2world,
